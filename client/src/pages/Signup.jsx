          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                <a
                  href="#"
                  className="inline-flex w-full justify-center rounded-md border border-[#F4F1EB] bg-[#F8F6F0] py-2 px-4 text-sm font-medium text-[#A0A0A0] shadow-sm hover:bg-white hover:shadow-luxe transition-all duration-300"
                >
