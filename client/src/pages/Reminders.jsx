  ...
  return (
    ...
    >
      ...
      <div className="flex border-b border-gray-200 mb-8">
        <button
          className={`py-4 px-6 font-medium text-sm ${viewType === 'all'
        ...
        <button
          className={`py-4 px-6 font-medium text-sm ${viewType === 'upcoming'
              ? 'border-b-2 border-primary-500 text-primary-600'
              : 'text-gray-500 hover:text-gray-700'
            }`}
        ...
        <button
          className={`py-4 px-6 font-medium text-sm ${viewType === 'completed'
              ? 'border-b-2 border-primary-500 text-primary-600'
              : 'text-gray-500 hover:text-gray-700'
            }`}
